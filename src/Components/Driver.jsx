...
const Driver = () => {
    ...
    return (
        <section>
            ...
            <div
                className={`fixed top-0 left-0 w-[395px] h-full bg-black border-r rounded-r-lg shadow-lg z-50 flex flex-col p-4 text-white transform transition-transform duration-500 ease-in-out ${activeDriver === 'driver1' ? 'translate-x-0' : '-translate-x-full'}`}
            >
