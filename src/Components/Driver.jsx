    ...
    return (
        <section>
            ...
            >
                ...
                <span className="absolute -inset-1.5 rounded-full border-2 border-white opacity-50 animate-ping"></span>
                <span className="absolute -inset-0.5 rounded-full border-2 border-white opacity-40 animate-ping"></span>
            ...
            {isOpen && (
                <div data-aos="zoom-in"
                    className="fixed bottom-28 right-[50px] flex flex-col items-center space-y-3 z-50">
                    <button
            ...
            <div
                className={`fixed top-0 left-0 w-[335px] h-full bg-black border-r rounded-r-lg shadow-lg z-50 flex flex-col p-4 text-white transform transition-transform duration-500 ease-in-out ${activeDriver === 'driver1' ? 'translate-x-0' : '-translate-x-full'} max-sm:w-full`}
            >
